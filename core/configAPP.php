...
const DRIVER="mysql"; // Tipo de conexion a la base de datos
const SERVER="localhost"; // Servidor de la base de datos
const DB="db_gesticket"; // Nombre de la base de datos
...
#define('DB_LOG_PATCH', 'D:/Desarrollo/laragon/www/GesTicket/core/logs/DB_ERRORS.txt');
define('DB_LOG_PATCH', 'C:/laragon/www/GesTicket/core/logs/DB_ERRORS.txt');