            ...
            <ul class="list-unstyled">
              <li class="d-flex align-items-center">
                <div class="posts-thumb">
                  <a href="#"><img loading="lazy" alt="news-image" src="<?=PATH_IMG?>news/news1.jpg"></a>
                </div>
                <div class="post-info">
              ...
              <li class="d-flex align-items-center">
                <div class="posts-thumb">
                  <a href="#"><img loading="lazy" alt="news-img" src="<?=PATH_IMG?>news/news2.jpg"></a>
                </div>
                <div class="post-info">
                  <h4 class="entry-title">
              ...
              <li class="d-flex align-items-center">
                <div class="posts-thumb">
                  <a href="#"><img loading="lazy" alt="news-img" src="<?=PATH_IMG?>news/news3.jpg"></a>
                </div>
                <div class="post-info">
                  <h4 class="entry-title">
