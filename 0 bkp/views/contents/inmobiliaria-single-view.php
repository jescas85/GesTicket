<!--/ Header end -->
<div id="banner-area" class="banner-area" style="background-image:url(<?=PATH_IMG?>banner/inmobiliaria.jpg)">
  <div class="banner-text">
    <div class="container">
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Inmobiliaria</h1>
        ...
        <div class="sidebar sidebar-left">
          <div class="widget">
            ...
            <ul class="nav service-menu">
              <li><a href="service-single">Home Construction</a></li>
              <li class="active"><a href="service-single">Building Remodels</a></li>
          ...
          <div class="widget">
            <div class="quote-item quote-border">
              ...
              <div class="quote-item-footer">
                <img loading="lazy" class="testimonial-thumb" src="<?=PATH_IMG?>clients/testimonial1.png" alt="testimonial">
      ...
      <div class="col-xl-8 col-lg-8">
        <div class="content-inner-page">
          ...
          <div id="page-slider" class="page-slider">
            <div class="item">
              <img loading="lazy" class="img-fluid" src="<?=PATH_IMG?>projects/project1.jpg" alt="project-slider-image" />
            </div>

            <div class="item">
              <img loading="lazy" class="img-fluid" src="<?=PATH_IMG?>projects/project2.jpg" alt="project-slider-image" />
            </div>
          </div><!-- Page slider end -->
