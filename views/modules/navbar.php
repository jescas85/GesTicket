...
<nav class="navbar navbar-expand-lg main-navbar">
	...
	<ul class="navbar-nav navbar-right">
				...
				<div class="dropdown-list-content dropdown-list-message">
					<a href="#" class="dropdown-item">
						<span class="dropdown-item-avatar text-white">
							<img alt="image" src="<?=PATH?>views/public/img/users/user-1.png" class="rounded-circle">
						</span>
					...
					<a href="#" class="dropdown-item">
						<span class="dropdown-item-avatar text-white">
							<img alt="image" src="<?=PATH?>views/public/img/users/user-2.png" class="rounded-circle">
						</span>
						<span class="dropdown-item-desc">
					...
					<a href="#" class="dropdown-item">
						<span class="dropdown-item-avatar text-white">
							<img alt="image" src="<?=PATH?>views/public/img/users/user-5.png" class="rounded-circle">
						</span>
						<span class="dropdown-item-desc">
					...
					<a href="#" class="dropdown-item">
						<span class="dropdown-item-avatar text-white">
							<img alt="image" src="<?=PATH?>views/public/img/users/user-4.png" class="rounded-circle">
						</span>
						<span class="dropdown-item-desc">
					...
					<a href="#" class="dropdown-item">
						<span class="dropdown-item-avatar text-white">
							<img alt="image" src="<?=PATH?>views/public/img/users/user-3.png" class="rounded-circle">
						</span>
						<span class="dropdown-item-desc">
		...
		<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
				<img alt="image" src="<?=PATH?>views/public/img/user.png" class="user-img-radious-style">
				<span class="d-sm-none d-lg-inline-block"></span></a>
			<div class="dropdown-menu dropdown-menu-right">
				<div class="dropdown-title">Hola! <?=$_SESSION["Nombres"];?></div>
				...
				<a href="<?=PATH?>logout.php" class="dropdown-item has-icon text-danger">
					<i class="fas fa-sign-out-alt"></i> Cerrar Sesión
				</a>
			</div>
		</li>
		<!-- <li><a href="#" data-toggle="sidebar1" class="nav-link nav-link-lg collapse-btn"><i class="fas fa-bars"></i></a></li> -->
		<!-- <li><a href="javascript:void(0)" class="settingPanelToggle"> <i class="fa fa-spin fa-cog"></i>  </a></li> -->
	</ul>
